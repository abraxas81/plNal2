...
class RacuniController extends Controller
{
    public function __construct()
    {
        ...
        view()->share('controller', 'RacuniController');
        view()->share('title', $this->getTitle('racuni'));
        view()->share('description', $this->getDescription('racuni'));
    }

    public function getIndex()
    {
        return view('datatables.racuni.index');
    }

    public function getPopis()
    {
        return view('datatables.racuni.basic');
    }
    ...
    public function getBasicData()
    {
        ...
        return Datatables::of($racuni)->make();
    }
