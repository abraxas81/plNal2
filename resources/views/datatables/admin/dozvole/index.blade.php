    ...
    @section('filters')
        <form id="filteri">
            <div class="splynx-nav-right">
                ...
                <a class="btn btn-xs btn-primary novi" data-toggle="modal" data-target="#Modal" data-action="dozvole"><i class="glyphicon glyphicon-edit"></i> {{$textDodajGumba}}</a>
            </div>
        </form>
    @endsection
@endsection
...
@section('js')
    <script type="text/javascript">
        ...
        var url = '{{ url("admin/dozvole/basic-data") }}';
