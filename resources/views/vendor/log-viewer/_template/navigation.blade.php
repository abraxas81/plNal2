    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a href="{{ route('log-viewer::dashboard') }}" class="navbar-brand">
                <i class="fa fa-fw fa-book"></i> Preglednik logova
            </a>
        </div>
        <ul class="nav navbar-nav">
            <li class="{{ Route::is('log-viewer::dashboard') ? 'active' : '' }}">
                <a href="{{ route('log-viewer::dashboard') }}">
                    <i class="fa fa-dashboard"></i> Upravljačka ploča
                </a>
            </li>
            <li class="{{ Route::is('log-viewer::logs.list') ? 'active' : '' }}">
                <a href="{{ route('log-viewer::logs.list') }}">
                    <i class="fa fa-archive"></i> Logovi
                </a>
            </li>
            <li>
                <a href="{{ route('welcome') }}">
                    <i class="fa fa-archive"></i> Glavna aplikacija
                </a>
            </li>
        </ul>
